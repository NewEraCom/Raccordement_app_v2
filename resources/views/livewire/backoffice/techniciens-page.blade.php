<div class="container-fluid">
                    ...
                    <table class="table table-centered table-responsive mb-0">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="text-center">Compteur de Planification</th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    {!!
                                    $item->player_id ? '<i class="uil-bell text-success font-16"></i>' : '<i
                                ...
                                <td class="text-center">{{ $item->planification_count }}</td>
                                ...
                                <td class="text-end">
                                    <div class="dropdown float-end">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                            <a href="{{ route('admin.techniciens.profile',$item) }}" ß
                                                class="dropdown-item"><i class="uil uil-eye me-1"></i>Profil</a>
                                            <button wire:click="$set('user_id',{{ $item->user->id }})"
                                                data-bs-toggle="modal" data-bs-target="#desactive-modal"
                                                class="dropdown-item"><i class="uil uil-{{ $item->user->status ? 'times' : 'check' }}-circle me-1"></i>  {{ $item->user->status ? 'Désactiver' : 'Activer' }} 
                                            </button>
                                            <button wire:click="$set('technicien_id',{{ $item->id }})"
                                                data-bs-toggle="modal" data-bs-target="#refresh-modal"
                                                class="dropdown-item"><i class="uil uil-refresh me-1"></i>Rafraîchir
                                            </button>
                                            <button lass="btn btn-warning btn-sm shadow-none"
                                                wire:click="setTech({{ $item }})" data-bs-toggle="modal"
                                                data-bs-target="#edit-modal" class="dropdown-item"><i
                                                    class="uil uil-pen me-1"></i>Modifier
                                            </button>
   ...
   <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="add-modalLabel"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-6 mb-2">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Ex : Amine"
                            ...
                            <div class="col-xl-12 mb-2">
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="floatingInput"
                                        placeholder="Ex : a.harti@neweracom.ma" wire:model.lazy="email" required />
                            ...
                            <div class="col-xl-12 mb-2">
                                <div class="form">
                                    <select id="example-multiselect" multiple class="form-control" wire:model="city_id"
                                        required>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xl-6 mb-2">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingInput" placeholder="Ex : Amine"
                                        wire:model="e_first_name" required />
                                    <label for="floatingInput">Prénom de technicien</label>
                                </div>
                            </div>
                            <div class="col-xl-6 mb-2">
                            ...
                            <div class="col-xl-12 mb-2">
                                <div class="form-floating">
                                    <select class="form-select" id="floatingSelect" wire:model="e_soustraitant_id"
                                        required>
                            ...
                            <div class="col-xl-12 mb-2">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="floatingInput" placeholder="Ex : 3"
                                        wire:model="e_counter" />
                                    <label for="floatingInput">Compteur de planification</label>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-2">
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="floatingInput" placeholder="Ex : 2"
                                        wire:model="e_city_compteur" />
                                    <label for="floatingInput">Compteur d'affectation par ville</label>
                                </div>
                            </div>
                            <div class="col-xl-12 mb-2">
                                <div class="form-floating">
                                    <input type="password" class="form-control" id="floatingInput" value=""
                                        autocomplete="new-password" wire:model="e_password" />
    ...
    <div id="delete-all-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importation-modalLabel"
        aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
    ...
    <div id="desactive-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importation-modalLabel"
        aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form wire:submit.prevent="disable">
                    ...
                    <div class="modal-body">
                        <p class="fw-bold f-16">Êtes-vous sûr de vouloir désactiver/activer le compte technicien?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light shadow-none" data-bs-dismiss="modal">Fermer</button>
                        <button type="submit" class="btn btn-danger shadow-none">
    ...
    <div id="refresh-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="importation-modalLabel"
        aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
