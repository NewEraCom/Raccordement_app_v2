...
<div class="container">
    ...
    <p>Je voulais vous informer que j'ai contacté le client {{ $client->sip }}.</p>
    ...
    @if($client->feedback)
    <p>Blocage : {{ $client->feedback->comment == 'Autre' ? $client->feedback->second_comment : $client->feedback->comment}}</p>
