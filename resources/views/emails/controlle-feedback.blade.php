...
<div class="container">
    ...
    <p>Je tenais à attirer votre attention sur l'installation de le client, {{ $client->sip }}, qui était prévue pour le
        {{ $client->affectations->last()->planification_date }}.</p>
