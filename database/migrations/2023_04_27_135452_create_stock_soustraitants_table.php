...
class CreateStockSoustraitantsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stock_soustraitants', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('stock_soustraitants');
    }
}
