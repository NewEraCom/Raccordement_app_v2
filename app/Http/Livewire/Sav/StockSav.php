...
class StockSav extends Component
{
    ...
    public function render(StockChart $chart)
    {
        ...
        $soustraitantStock = StockService::getSoustraitantStockSav($this->soustraitant);
        $soustraitants = Soustraitant::get(['id', 'name']);
        return view('livewire.sav.stock', compact(['soustraitants', 'stock', 'soustraitants', 'soustraitantStock']), ['chart' => $chart->build()])->layout('layouts.app', ['title' => 'Stock']);
    }
}
