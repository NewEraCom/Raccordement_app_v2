...
class SavExport implements WithMultipleSheets
{
    use Exportable;
    ...
    {
        $sheets = [
            'CANVA_' . now() => new SavClientExport($this->start_date,$this->end_date,$this->technicien),
...
//'Clients Restant' => new ClientsRestantExport(),
          //  'Affectation Bloque' => new AffectationBlocage($this->technicien,$this->start_date,$this->end_date),
            'Affectation Historique' => new SavClientHistorique($this->technicien,$this->start_date,$this->end_date),
